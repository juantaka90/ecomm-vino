...
<h5 className="card-title" style={{textAlign:"left"}}>{item.name}</h5>
    ...
    <h6 className="card-text" style={{textAlign:"left"}}><small >Precio Por Unidad: {item.cost} </small></h6>
    <h6 className="card-text" style={{textAlign:"left"}}><small >Precio Total: {item.cost * item.cantidadItems} </small></h6>
